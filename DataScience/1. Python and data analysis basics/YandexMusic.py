...
def find_hip_hop(table, wrongName):
    table['genre_name'] = table['genre_name'].replace(wrongName, 'hiphop')
    return table[table['genre_name'] == wrongName]['genre_name'].count()
...
def genre_weekday(df, day, time1, time2):    
    ...
    genre_list_sorted = genre_list_sorted.sort_values(by='time', ascending=False)
